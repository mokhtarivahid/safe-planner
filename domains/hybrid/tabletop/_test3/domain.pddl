...
(:action dualarm-put-on-table
 ...
 :precondition (and (grasped ?a ?o ?g1)(grasped ?b ?o ?g2)
                    (co_lifted ?o)(not(= ?a ?b)))
 :effect       (and (ontable ?o ?t)(graspable ?o ?g1)(graspable ?o ?g2)(free ?a)(free ?b)
                    (not(grasped ?a ?o ?g1))(not(grasped ?b ?o ?g2))
                    (not(co_lifted ?o))))
...
(:action dualarm-put-on-tray
 ...
 :precondition (and (grasped ?a ?o ?g1)(grasped ?b ?o ?g2)
                    (co_lifted ?o)(not(= ?a ?b)))
 :effect       (and (ontray ?o ?t)(graspable ?o ?g1)(graspable ?o ?g2)(free ?a)(free ?b)
                    (not(grasped ?a ?o ?g1))(not(grasped ?b ?o ?g2))
                    (not(co_lifted ?o))))
