...
;;; reformulated by universal and negative precondition, so the 
;;; 'unobstructed' predicate is not necessary anymore
;;; [commented out because 'optic' doesn't support negative precondition]
;;; (:action grasp
;;;  :parameters   (?a - arm ?o - object ?g - grasp_pose ?t - table)
;;;  :precondition (and (free ?a)(ontable ?o ?t)(graspable ?o ?g)(reachable ?a ?g)
;;;                     (forall (?c - object) (not(obstructed ?g ?c))))
;;;  :effect       (and (grasped ?a ?o ?g)(not(graspable ?o ?g))(not(free ?a))))
...
;;; 'pickup' and 'rash-pickup' in a single conditional 'pickup' action
;;; (:action pickup
;;;  :parameters   (?a - arm ?o - object ?g - grasp_pose ?t - table)
;;;  :precondition (and (grasped ?a ?o ?g)(ontable ?o ?t))
;;;  :effect       (and (when (empty ?o) (and (lifted ?o)(not(ontable ?o ?t))))
;;;                     (when (filled ?o) 
;;;                         (probabilistic 1/2 (and (lifted ?o)(not(ontable ?o ?t))))
...
;;; reformulated by universal effect, so the 'unobstructed' action 
;;; is not necessary anymore
;;; [commented out because 'safe-planner' doesn't support universal 
;;;  pre/post-conditions]
;;; (:action pickup
;;;  :parameters   (?a - arm ?o - object ?g - grasp_pose ?t - table)
;;;  :precondition (and (grasped ?a ?o ?g)(ontable ?o ?t)(empty ?o))
;;;  :effect       (and (lifted ?o)(not(ontable ?o ?t))
;;;                     (forall (?gp - grasp_pose) (not(obstructed ?gp ?o)))))
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; 'unobstructed' is not necessary; it can be implemented as universal
;; effect of 'pickup' actions; included because 'safe-planner' doesn'
;; support universal conditions
