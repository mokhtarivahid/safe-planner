...
(:action pickup-empty
 ...
 :precondition (and (grasped ?a ?o ?g1)(ontable ?o)(empty ?o)
                    ...
                    (not(= ?g1 ?g2))(not(= ?g2 ?g3)))
 :effect       (and (probabilistic 1/2 (and (lifted ?a ?o)(not(ontable ?o))))
                    (probabilistic 1/2 (and (ontable ?o)(free ?a)(graspable ?o ?g1)(not(grasped ?a ?o ?g1))))))
...
(:action pickup-filled
 ...
 :precondition (and (grasped ?a ?o ?g1)(ontable ?o)(filled ?o)
                    (graspable ?o ?g2)(graspable ?o ?g3)
                    (not(= ?g1 ?g2))(not(= ?g2 ?g3)))
 :effect       (and (probabilistic 1/3 (and (lifted ?a ?o)(not(ontable ?o))))
                    (probabilistic 1/3 (and (ontable ?o)(free ?a)(graspable ?o ?g1)(not(grasped ?a ?o ?g1))))
                    (probabilistic 1/3 (and (ontable ?o)(free ?a)(graspable ?o ?g1)(not(grasped ?a ?o ?g1))(not(filled ?o))(empty ?o)))))
...
(:action dualarm-pickup
 ...
 :effect       (and (co_lifted ?a ?b ?o)(not(ontable ?o))))
